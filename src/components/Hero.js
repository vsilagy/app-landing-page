		...
		<section id="hero">
			<div className="container flex flex-col-reverse mx-auto p-6 lg:flex-row">
				<div className="flex flex-col gap-8 lg:w-1/2 lg:gap-10 lg:mt-12">
					<h1 className="text-3xl font-medium text-center lg:text-5xl lg:text-left ">
					...
					<div className="flex justify-center items-center gap-5 lg:justify-start">
						...
						<a className="py-3 px-6 font-medium text-gray-800 bg-gray-300 rounded-md shadow-lg hover:bg-white hover:text-gray-800 hover:border-gray-800 hover:border-2 outline-none">
							Get it on Safari
						</a>
					</div>
				</div>
